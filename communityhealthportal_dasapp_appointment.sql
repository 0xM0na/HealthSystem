...
CREATE TABLE `dasapp_appointment` (
  ...
  CONSTRAINT `dasapp_appointment_ibfk_1` FOREIGN KEY (`doctor_id`) REFERENCES `dasapp_doctorreg` (`id`)
...
LOCK TABLES `dasapp_appointment` WRITE;
/*!40000 ALTER TABLE `dasapp_appointment` DISABLE KEYS */;
/*!40000 ALTER TABLE `dasapp_appointment` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-12-21  0:13:22
